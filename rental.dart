...
class RentalPage extends StatefulWidget {
  ...
  RentalPage({required this.book_id, required this.quantity});

  @override
  _PaymentPageState createState() => _PaymentPageState();
}

class _PaymentPageState extends State<RentalPage> {
  ...
  int getTotalPrice(Book book) {
    ...
    int parsedPrice = int.parse(book.rentprice.replaceAll(',', '')); // Remove commas if present
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(bottom: 8.0),
                            child: Text(
                              'Rent Price: ₱${snapshot.data!.rentprice} / ${snapshot.data!.rentdue} in ${snapshot.data!.rentduration}',
                              style: TextStyle(fontSize: 16),
                            ),
                          ),
                          Padding(
                            ...
                            return AlertDialog(
                              ...
                              content: Column(
                                ...
                                children: [
                                  Divider(),
                                  Text(
                                      "Are you sure you want to confirm rental?",
                                      style: TextStyle(
                                        fontSize: 20,
                                        color: Color.fromARGB(255, 57, 55, 66),
                                      ),),
                                ...
                                TextButton(
                                  onPressed: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Center(child: Text('Rental Successful')),
