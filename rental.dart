...
class _PaymentPageState extends State<RentalPage> {
  ...
  double getTotalPrice() {
    ...
    double parsedPrice = double.parse(widget.rentPrice.replaceAll(',', '')); // Remove commas if present
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(bottom: 8.0),
                          child: Text(
                            'Price: ₱${widget.rentPrice}/${widget.rentDue}\nin ${widget.rentTotalDue}',
                            style: TextStyle(fontSize: 16),
                          ),
                        ),
                        Padding(
                    ...
                    Row(
                      children: [
                        Padding(
                              ...
                              child: Text(
                                'Total Price:\n₱${getTotalPrice().toStringAsFixed(2)}/${widget.rentDue} in ${widget.rentTotalDue}',
                                style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
